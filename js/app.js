...
function goToVideo(delay) {
  setTimeout(function() {
    $('html, body').animate({ scrollTop: SELECTOR.find('.song').eq(currentVideo).offset().top }, 400);
  }, delay);
}
